...
function install (server, opts) {
  ...
  server.get('/repos/:owner/:repo/info/refs', middleware, function (req, res, next) {
    ...
    if (req.params.service) {
      ...
      var packet = "# service=git-" + service + "-pack\n";
      ...
      var head = prefix + packet + "0000";
      var result = [ ];
      result.push(head);
      req.repo.uploadPack("refs", function (err, refs) {
