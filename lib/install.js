...
function install (server, opts) {
  ...
  // var getRepoInfo = require('./handlers/server/repo-info')(opts, server);
  ...
  // var getOwnerInfo = require('./handlers/server/owner-info')(opts, server);
  ...
  // var testUpload = require('./handlers/upload/dummy')(opts, server);
